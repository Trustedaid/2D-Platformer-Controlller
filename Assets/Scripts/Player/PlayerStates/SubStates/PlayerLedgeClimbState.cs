...
public class PlayerLedgeClimbState : PlayerState
{
    ...
    {
        isTouchingCeiling = Physics2D.Raycast(cornerPos + (Vector2.up * 0.015f) + (Vector2.right * core.Movement.FacingDirection * 0.015f), Vector2.up, playerData.stanColliderHeight, core.CollisionSenses.WhatIsGround);
